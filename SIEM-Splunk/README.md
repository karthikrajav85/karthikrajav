# SIEM - Splunk Projects (BOTS v3)

## Overview

This repository contains hands-on cybersecurity projects performed using Splunk and the BOTS v3 dataset.
The focus of these projects is to analyze network and system logs, detect anomalies, and identify potential security threats.
...
* Log analysis (DNS, network traffic, authentication logs)
* Data visualization
